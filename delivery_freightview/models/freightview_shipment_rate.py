...
class FreightviewShipmentRate(models.Model):
    ...
    blindshipping_charge = fields.Float('Blindshipping')
    notify_charge = fields.Float('Notify Charge')
    appoint_charge = fields.Float('Appoint Charge')
    over_dimension_charge = fields.Float('Overlength Charge')
